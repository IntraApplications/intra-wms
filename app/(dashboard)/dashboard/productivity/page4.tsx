    ...
    <div className="h-full">
      ...
      <div className="p-6 max-w-[1320px] mx-auto">
        ...
        <div className="flex gap-6">
            ...
            <svg className="w-full h-[600px]" viewBox="0 0 300 750">
              ...
              {mainCommits.map((item, index) => {
                ...
                return (
                  ...
                  >
                    {/* Commit Node */}
                    {/* **Background Rectangle Behind Texts** */}
                    <rect
                      x={mainX - 75} // Adjust based on expected text width
                      y={mainY + 10} // Position above the text
                      width={150} // Adjust width as needed
                      height={46} // Adjust height to cover both text elements
                      fill="#1A1A1B" // Same as the background color
                      pointerEvents="none" // Ensure it doesn't block interactions
                    />
                    <rect
                      x={mainX - 75} // Adjust based on expected text width
                      y={mainY - 30} // Position above the text
                      width={150} // Adjust width as needed
                      height={46} // Adjust height to cover both text elements
                      fill="#1A1A1B" // Same as the background color
                      pointerEvents="none" // Ensure it doesn't block interactions
          ...
          {/* Sidebar with Online Users and Commit History */}

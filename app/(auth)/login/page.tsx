          ...
          <div className="mt-10">
              ...
              <form onSubmit={handleSubmit(onSubmit)} className="space-y-10 justify-center">
                ...
                <div className="flex items-center justify-between mt-10">
                  <div className="flex items-center">
                    ...
                    <label
                      htmlFor="remember-me"
                      className="ml-3 block text-sm leading-6 text-neutral"
                    >
                      Remember me
                    </label>
                  </div>
            ...
            <div className="mt-10">
              <div className="flex justify-center pb-3">
                <span className="px-6 text-neutral justify-center">
                  Or continue with
                </span>
              </div>
              ...
              <div className="mt-6 grid grid-cols-2 gap-4">
                <a
                  href="#"
                  className="flex w-full items-center justify-center gap-3 rounded bg-[#1D9BF0] px-3 py-1.5 text-white focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#1D9BF0]"
                >
                  <svg
                    className="h-5 w-5"
                    aria-hidden="true"
